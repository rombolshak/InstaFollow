...
class CurlHttpClient {
    ...
    */
    ...
    protected function _setOptions($uri) {
        ...
        curl_setopt($this->handler, CURLOPT_USERAGENT, "Mozilla/5.0");
	...
	* class array variable.
     ...
     * @return mixed[]
     */
    public function extractHeaders($response) {
        $headers = array();
        ...
        foreach($lines as $line) {
            $parts = explode(":", $line);
            if ($parts[0] == "X-Ratelimit-Remaining")
                $headers['remaining'] = (int)$parts[1];
            /*
            $line = trim($line, "\r\n");
            if ($line == "") break;
